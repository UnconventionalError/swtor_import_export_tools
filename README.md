# SWTOR Granny2 (.gr2) Import/Export Add-on for Blender 4.5 LTS & 5.2 LTS.
...
* **SWTOR .CLO physics bones import (DOESN'T WORK):**  
It was meant for converting 32-bit .clo physics-based bones data (clothes, hair, Twi'lek lekku, etc.), but actually just read their names to separate the matching vertex groups into a separate object and apply a Blender physics simulation to them, which it did rather badly (pinning failures, etc.). We are keeping the import menu option visible to facilitate testing new code.  
...
* **SWTOR 64-bit .gr2 objects export:**  
  ...
  **FUNCTIONAL TO AN EXTENT! If using it, please report any issue to our Discord**.
